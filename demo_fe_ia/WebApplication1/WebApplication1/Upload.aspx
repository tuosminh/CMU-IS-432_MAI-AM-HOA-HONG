            ...
            <div class="upload-form">
                ...
                <div class="form-fields">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txttitle" runat="server" CssClass="text-input" Placeholder="Enter content">
                        </asp:TextBox>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="lbldanhmuc" runat="server" Text="Categories"></asp:Label>
                        <asp:TextBox ID="txtLoai" runat="server" CssClass="text-input" Placeholder="Categories">
                        </asp:TextBox>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="lblmota" runat="server" Text="Artwork description"></asp:Label>
                        <asp:TextBox ID="txtmota" runat="server" CssClass="text-input" TextMode="MultiLine" Rows="4"
                            Placeholder="Enter the artwork description"></asp:TextBox>
                    </div>
                    <div class="form-group">
