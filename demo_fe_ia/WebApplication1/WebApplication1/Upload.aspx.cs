        ...
        protected void btndang_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload1.HasFile)
            {
                try
                {
                    ...
                    string sql = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=D:\\git_MAHH\\LY_NAM-SPM-\\demo_fe_ia\\WebApplication1\\WebApplication1\\App_Data\\Database1.mdf;Integrated Security=True"; // Thay bằng chuỗi kết nối thực tế của bạn
